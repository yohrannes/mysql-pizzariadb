...
-- Relacionando tb_entrege com tb_vendidos
alter table tb_entrega add id_venda int;
alter table tb_entrega
add foreign key (id_venda)
references tb_vendidos(id_venda);
...
drop table tb_pratos;
describe tb_funcionarios;
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (1, 'janaina','recepcionista',571461497,1530.00,1992895779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (3, 'sergio','recepcionista', 575161497,1800.00,1992655779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (4, 'iracema','pizzaiolo', 571461497,1130.00,1992891879);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (5, 'miquel','gerente', 571461497,1330.00,1992898779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (6, 'francisco','motoboy', 571461497,1030.00,1991895779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (7, 'paulo','assistente', 571461497,2030.00,1992818779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (8, 'timóteo','garçon', 571461497,1630.00,1992894179);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (9, 'gustavo','faxineiro', 571461497,1730.00,1992848779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (10, 'josé','vigia', 571461497,1850.00,1992865779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (11, 'leandro','dono', 571461497,2300.00,1992848779);
insert into tb_funcionarios(id_funcionario,nome_funcionario,f_funcionario, rg_funcionario, salario_funcionario,tel_funcionario) values (12, 'marcos','garçon', 571461497,2000.00,1998495779);
update tb_funcionarios set f_funcionario = 'recepcionista' where id_funcionario=2;



select* from tb_vendidos;
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (1,1,150.00,11,11);-- TABELA VENDIDOS
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (2,2,160.00,10,10);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (3,3,180.00,9,9);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (4,4,200.00,8,8);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (5,5,125.00,7,7);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (6,6,135.00,6,6);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (7,7,140.00,5,5);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (8,8,210.00,4,4);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (9,9,142.00,3,3);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (10,10,126.00,2,2);
insert into tb_vendidos(id_cliente,id_venda,valor_venda,id_pizza,id_pagamento) values (11,11,111.00,1,1);
update tb_vendidos set dt_venda = '2006-11-21' where id_venda=1;
update tb_vendidos set dt_venda = '2006-12-20' where id_venda=2;
update tb_vendidos set dt_venda = '2006-10-19' where id_venda=3;
update tb_vendidos set dt_venda = '2006-02-08' where id_venda=4;
update tb_vendidos set dt_venda = '2006-03-07' where id_venda=5;
update tb_vendidos set dt_venda = '2006-05-06' where id_venda=6;
update tb_vendidos set dt_venda = '2006-06-05' where id_venda=7;
update tb_vendidos set dt_venda = '2006-07-04' where id_venda=8;
update tb_vendidos set dt_venda = '2006-08-03' where id_venda=9;
update tb_vendidos set dt_venda = '2006-08-02' where id_venda=10;
update tb_vendidos set dt_venda = '2006-09-01' where id_venda=11;
...
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (1,'muçarela');-- TABELA INGREDIENTES
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (2,'atum');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (3,'calabresa');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (4,'bacon');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (5,'requeijão');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (6,'tomate');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (7,'cebola');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (8,'brocolis');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (9,'banana');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (10,'chocolate');
insert into tb_ingredientes(id_ingrediente,nome_ingrediente) values (11,'coco');



select*from tb_pagamento;
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (1,'cartao',150.00); -- TABELA PAGAMENTO
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (2,'cartao',160.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (3,'cartao',180.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (4,'cartao',200.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (5,'dinheiro',125.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (6,'cartao',135.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (7,'cartao',140.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (8,'cartao',210.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (9,'dinheiro',142.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (10,'cartao',126.00);
insert into tb_pagamento (id_pagamento,f_pagamento,valor_pago) values (11,'dinheiro',111.00);
...
select dt_pagamento, id_pagamento, valor_pago, f_pagamento from tb_pagamento order by dt_pagamento;
select f_pagamento, id_pagamento, valor_pago, dt_pagamento from tb_pagamento order by f_pagamento;
