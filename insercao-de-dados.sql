...
INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (1, 'janaina', 'liberdade', 345, 'parquedoslirios', 'feminino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (2, 'sergio', 'jardimpaz', 365, 'pdlirios', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (3, 'marcelo', 'liberdade', 618, 'parquedosl', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (4, 'augusto', 'liberdade', 584, 'jdimpaz', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (5, 'samuel', 'iracema', 618, 'parquedosl', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (6, 'wanderlei', 'liberdade', 500, 'jdbrasilia', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (7, 'isaque', 'iracema', 619, 'parquedosl', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (8, 'roberto', 'cariris', 745, 'jdimpaz', 'masculino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (9, 'marcia', 'pirituba', 318, 'parquedosl', 'feminino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (10, 'marilsa', 'acarai', 45, 'liberdade', 'feminino');

INSERT INTO tb_cliente (id_cliente, nome_cliente, rua, numero, bairro, sexo)
VALUES (11, 'fatima', 'pirituba', 519, 'parquedosl', 'feminino');
...
INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (1, 'janaina', 'recepcionista', 571461497, 1530.00, 1992895779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (3, 'sergio', 'recepcionista', 575161497, 1800.00, 1992655779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (4, 'iracema', 'pizzaiolo', 571461497, 1130.00, 1992891879);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (5, 'miquel', 'gerente', 571461497, 1330.00, 1992898779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (6, 'francisco', 'motoboy', 571461497, 1030.00, 1991895779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (7, 'paulo', 'assistente', 571461497, 2030.00, 1992818779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (8, 'timóteo', 'garçon', 571461497, 1630.00, 1992894179);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (9, 'gustavo', 'faxineiro', 571461497, 1730.00, 1992848779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (10, 'josé', 'vigia', 571461497, 1850.00, 1992865779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (11, 'leandro', 'dono', 571461497, 2300.00, 1992848779);

INSERT INTO tb_funcionario (id_funcionario, nome_funcionario, func_funcionario, rg_funcionario, sal_funcionario, tel_funcionario)
VALUES (12, 'marcos', 'garçon', 571461497, 2000.00, 1998495779);
...
INSERT INTO tb_ingrediente (id_ingrediente, nome_ingrediente)
VALUES (1, 'muçarela');
...
INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (2, 'bauru', 'salgada', 24.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (3, 'espanhola', 'salgada', 24.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (4, 'pretigio', 'doce', 24.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (5, 'strogonoff', 'salgada', 24.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (6, 'cheddar', 'salgada', 29.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (7, 'banana', 'doce', 34.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (8, 'frango', 'salgada', 34.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (9, 'marguerita', 'salgada', 35.99);

INSERT INTO tb_cardapio (id_pizza, nome_pizza, tipo_pizza, valor_pizza)
VALUES (10, 'portuguesa', 'salgada', 34.99);
...
VALUES (1, 'cartao', 150.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (2, 'cartao', 160.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (3, 'cartao', 180.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (4, 'cartao', 200.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (5, 'dinheiro', 125.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (6, 'cartao', 135.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (7, 'cartao', 140.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (8, 'cartao', 210.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (9, 'dinheiro', 142.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (10, 'cartao', 126.00);

INSERT INTO tb_pagamento (id_pagamento, form_pagamento, valor_pago)
VALUES (11, 'dinheiro', 111.00);
...
INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (1, 1, 150.00, 11, 11); -- TABELA VENDIDOS

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (2, 2, 160.00, 10, 10);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (3, 3, 180.00, 9, 9);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (4, 4, 200.00, 8, 8);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (5, 5, 125.00, 7, 7);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (6, 6, 135.00, 6, 6);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (7, 7, 140.00, 5, 5);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (8, 8, 210.00, 4, 4);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (9, 9, 142.00, 3, 3);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (10, 10, 126.00, 2, 2);

INSERT INTO tb_venda (id_cliente, id_venda, valor_venda, id_pizza, id_pagamento)
VALUES (11, 11, 111.00, 1, 1);
...
/* Inserindo dados na tabela tb_entrega */
INSERT INTO tb_entrega (id_entrega, id_funcionario, id_cliente, id_venda)
VALUES (1, 6, 1, 1);
